    ...
    t.extend(t.fn, {
        ...
        rules: function (e, i) {
            ...
            if (e) {
                ...
                var n = r.rules;
                var a = t.validator.staticRules(s);
                switch (e) {
                    case 'add':
        ...
        prototype: {
            init: function () {
                function e(e) {
                    ...
                    var s = 'on' + e.type.replace(/^validate/, '');
                ...
                return a[i.name] = e, t.ajax(t.extend(!0, {
                        ...
                        success: function (s) {
                            ...
                            if (a) {
                                ...
                                var o = {};
                                var l = s || n.defaultMessage(i, 'remote');
