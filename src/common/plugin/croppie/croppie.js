...
(function (root, factory) {
    ...
    if (typeof Promise !== 'function') {
        ...
        !function (a) {
            ...
            var j = setTimeout;
            var k = 'function' == typeof setImmediate && setImmediate || function (a) {
                j(a, 1);
            };
    ...
    function _getVirtualBoundaries(viewport) {
        ...
        var centerFromBoundaryX = self.options.boundary.width / 2;
        var centerFromBoundaryY = self.options.boundary.height / 2;
    ...
    function _transferImageToCanvas(customOrientation) {
        ...
        var ctx = canvas.getContext('2d');
        var exif = _hasExif.call(self);
        var customOrientation = self.options.enableOrientation && customOrientation;
        ...
        if (exif) {
            getExifOrientation(img, function (orientation) {
                drawCanvas(canvas, img, parseInt(orientation, 10));
    ...
    function _get() {
        ...
        var widthDiff = (vpData.width - self.elements.viewport.offsetWidth) / 2;
    ...
    function _result(options) {
        ...
        var opts = deepExtend(RESULT_DEFAULTS, deepExtend({}, options));
